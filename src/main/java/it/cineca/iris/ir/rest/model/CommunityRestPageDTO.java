 ...
 *
 */
public class CommunityRestPageDTO {
    
    private String next;
    private String prev;
    private List<CommunityRestDTO> restResourseDTOList;
    ...
    public List<CommunityRestDTO> getRestResourseDTOList() {
        return restResourseDTOList;
    }

    public void setRestResourseDTOList(List<CommunityRestDTO> restResourseDTOList) {
        this.restResourseDTOList = restResourseDTOList;
    }

    public CommunityRestPageDTO() {
        super();
    }
