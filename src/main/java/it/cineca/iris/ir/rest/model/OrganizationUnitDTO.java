...
public class OrganizationUnitDTO {
    ...
    @JsonCreator
    public OrganizationUnitDTO(@JsonProperty("uniqueIdentifier") String uniqueIdentifier, @JsonProperty("uuid") String uuid, @JsonProperty("id") long id, @JsonProperty("description") String description, @JsonProperty("displayValue") String displayValue, @JsonProperty("startDate") String startDate, @JsonProperty("endDate") String endDate, @JsonProperty("organizationUnitType") OrganizationUnitType organizationUnitType, @JsonProperty("gaSourceIdentifiers") GaSourceIdentifier[] gaSourceIdentifiers){
